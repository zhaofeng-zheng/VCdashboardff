...
shinyApp(ui=   
 ...
 #####################-Clients-#####################################################------------   
   ...
   bs4Card(  id = "OurClients",  # type = 1,   imageElevation = 4,  # height = "40px",
            title = userDescription(  title = span("Our Clients", style ="font-size: 30px; color: white" ) , 
                  # subtitle = span("_", style ="font-size: 25px; color: #1117FB" ) ,
            image = "https://visicaseaustralia.sharepoint.com/:i:/r/sites/DataAnalytics-liftingthefog/Shared%20Documents/Analytics/Data/Devin%20zheng%20images/client%20white.png?csf=1&web=1&e=ikAUwD"), status = "primary",
          ...
          bs4DashControlbar ( br(),  br(),  br(),  br(),  br(), br(),
              "Filters and Selections ", disable = FALSE,width = 250,skin = "light", status = "white",
            ...
            selectInput('y', 'Values:', choices = c( "Revenue" = "Expended", "Number of Active Clients" = "Client" , 
                    ...
                    selected = "Expended"),
            selectInput('l', 'Filters and Groups', 
            ...
            pickerInput(
                ...
                selected = unique(VCA_Clients_actuals_monthly$Gender),
                choices = unique(VCA_Clients_actuals_monthly$Gender),
                multiple = TRUE,
                options = pickerOptions( 'live-search' = TRUE,actionsBox = TRUE, 
            ...
            pickerInput(
                ...
                selected = unique(VCA_Clients_actuals_monthly$AgeBands),
                choices = unique(VCA_Clients_actuals_monthly$AgeBands),
                multiple = TRUE,
                options = pickerOptions( 'live-search' = TRUE,actionsBox = TRUE,  
            ...
            pickerInput(
                ...
                selected = unique(VCA_Clients_actuals_monthly$Preferred_language),
                choices = unique(VCA_Clients_actuals_monthly$Preferred_language),
                multiple = TRUE,
                 options = pickerOptions( 'live-search' = TRUE,actionsBox = TRUE, 
          ...
          pickerInput(
                ...
                selected = unique(VCA_Clients_actuals_monthly$ATSI),
                choices = unique(VCA_Clients_actuals_monthly$ATSI),
                multiple = TRUE,
                options = pickerOptions( 'live-search' = TRUE,actionsBox = TRUE,
          ...
          pickerInput(
                ...
                selected = unique(VCA_Clients_actuals_monthly$Country_of_birth),
                choices = unique(VCA_Clients_actuals_monthly$Country_of_birth),
                multiple = TRUE,
                 options = pickerOptions( 'live-search' = TRUE,actionsBox = TRUE,  
          ...
          pickerInput(
                ...
                selected = unique(VCA_Clients_actuals_monthly$Ethnic_status),
                choices = unique(VCA_Clients_actuals_monthly$Ethnic_status),
                multiple = TRUE,
                 options = pickerOptions( 'live-search' = TRUE,actionsBox = TRUE, 
          ...
          pickerInput(
                ...
                selected = unique(VCA_Clients_actuals_monthly$Marital_status),
                choices = unique(VCA_Clients_actuals_monthly$Marital_status),
                multiple = TRUE, 
                 options = pickerOptions( 'live-search' = TRUE,actionsBox = TRUE, 
         ...
         br(),
         br(),  
         bs4Card( width = 12,  title= span("Vacant Shifts ", style ="font-size: 25px; color: black;" ),  elevation = 5,  
...
#####################-END Clients-#####################################################
 ...
 #####################-Safety-#####################################################------------   
   ...
   bs4Card(  id = "OurSafety",   type = 1,   imageElevation = 4,  # height = "40px",
            title = userDescription(  title = span("Our Safety", style ="font-size: 30px; color: white" ) , 
                  # subtitle = span("_", style ="font-size: 25px; color: #1117FB" ) ,
            image = "https://visicaseaustralia.sharepoint.com/:i:/r/sites/DataAnalytics-liftingthefog/Shared%20Documents/Analytics/Data/Devin%20zheng%20images/safety%20white.png?csf=1&web=1&e=MgSRpe"), status = "warning",
            # headerBorder = TRUE, controlbar_icon = "cogs",boxToolSize = "lg",
            #labelText = span("Our Sustainability", style ="font-size: 30px; color: white;" ), 
          ...
          bs4Card(width = 12,title= span("Starburst drilldown: Incident Severity", 
                                         style ="font-size: 25px; color: black;" ),elevation = 5,
                  plotlyOutput("starburst", height = "620px")),
...
#####################-END Safety-#####################################################
 ...
 #####################-Workers-#####################################################------------   
   ...
   bs4Card(  id = "OurWorkers",   type = 1,   imageElevation = 4,  # height = "40px",
            title = userDescription(  title = span("Our Workers", style ="font-size: 30px; color: white" ) , 
                  # subtitle = span("_", style ="font-size: 25px; color: #1117FB" ) ,
            image = "https://visicaseaustralia.sharepoint.com/:i:/r/sites/DataAnalytics-liftingthefog/Shared%20Documents/Analytics/Data/Devin%20zheng%20images/worker%20white.png?csf=1&web=1&e=J2jOi7"), status = "success",
            # headerBorder = TRUE, controlbar_icon = "cogs",boxToolSize = "lg",
            #labelText = span("Our Sustainability", style ="font-size: 30px; color: white;" ), 
            closable = FALSE ,width = 12,  solidHeader = TRUE, height = "100%", collapsible = TRUE, 
            maximizable	= TRUE ,collapsed =  TRUE,  maximized	= FALSE,   elevation = 4 ,
          ...
          bs4DashNavbar( title = NULL, titleWidth = NULL,disable = FALSE,.list = NULL, leftUi = NULL,rightUi = NULL,
          skin = "light", status = "warning", border = FALSE   ,compact = TRUE ,#sidebarIcon = shiny::icon("bars"),
            controlbarIcon = shiny::icon("filter"),  fixed = FALSE),
          
          bs4DashControlbar (   br(),  br(),  br(),  br(),  br(), br(),
              "Filters and Selections ", disable = FALSE,width = 250,skin = "light", status = "warning",
            elevation = 4,   collapsed = FALSE ,  minified = TRUE,  expandOnHover = TRUE, startOpen = TRUE,
...
#####################-Sustainability-#####################################################------------   
   ...
   bs4Card(  id = "OurBusiness",   type = 1,   imageElevation = 4,  # height = "40px",
            title = userDescription(  title = span("Our Business", style ="font-size: 30px; color: white" ) , 
                  # subtitle = span("_", style ="font-size: 25px; color: #1117FB" ) ,
            image = "https://visicaseaustralia.sharepoint.com/:i:/r/sites/DataAnalytics-liftingthefog/Shared%20Documents/Analytics/Data/Devin%20zheng%20images/business%20white.png?csf=1&web=1&e=yIG53h"), status = "danger",
            # headerBorder = TRUE, controlbar_icon = "cogs",boxToolSize = "lg",
            #labelText = span("Our Sustainability", style ="font-size: 30px; color: white;" ), 
            closable = FALSE ,width = 12,  solidHeader = TRUE, height = "100%", collapsible = TRUE, 
            maximizable	= TRUE ,collapsed = TRUE ,maximized	= FALSE,   elevation = 4 ,
          ...
          bs4DashNavbar( title = NULL, titleWidth = NULL,disable = FALSE,.list = NULL, leftUi = NULL,rightUi = NULL,
          skin = "light", status = "danger", border = FALSE   ,compact = TRUE ,#sidebarIcon = shiny::icon("bars"),
            controlbarIcon = shiny::icon("filter"),  fixed = FALSE),
  ...
  tags$head(tags$style(
    HTML(
      "div.widget-user-image > img.img-circle {
          border-radius: 0%;
          height: 100px;
          width: 100px;
        }"
...
output$ClientCohortAging <-  renderPlotly( { 
  ...
  ggplotly ({
    ( ggplot(Activebymonthplot_pct, aes(x=Retention_age, y=Percentage_of_Clients, 
             group=Client_retention, colour=Client_retention),  
...
output$incpieline  <- renderPlotly(  { 
  ...
  plot_ly()  %>% add_trace(data= VCA_Incidents %>%  
              ...
              layout(  xaxis2 = list(domain = c(0.2, 0.9), anchor='y2' , categoryorder = "array",
     ...
     as.sunburstDFM <- function(DFM, valueCol="Approved_Margin_perc"){ 
      ...
      sunburstDFM <- as.sunburstDFM(DFM, valueCol = "Approved_Margin_perc")
       ...
       sunburstDFM  <-  sunburstDFM %>% mutate(
              ...
              margin_band == "Negative or 0%"   ~ "F7D8BA",
              margin_band ==   "1% to 20%"   ~ "orange",   
              margin_band ==   "21% to 50%"    ~ "E1F8DC", 
              margin_band == "51% to 70%"    ~ "CAF1DE",
              margin_band == "71% to 100%"  ~ "ACDDDE",
              margin_band == "over 100%"  ~ "darkgreen",
              labels == "Negative or 0%"  ~ "F7D8BA",
              labels == "1% to 20%" ~ "orange",     #FFEF8DD
              labels == "21% to 50%"   ~ "E1F8DC", 
              labels == "51% to 70%"  ~ "CAF1DE",
              labels ==  "71% to 100%"  ~ "ACDDDE",
              labels ==  "over 100%" ~ "darkgreen"))
      
      plot_ly(data = sunburstDFM, sort = FALSE , ids = ~ids, labels= ~labels, parents = ~parents, 
                    values= ~values, type='sunburst' ,
              #  text = (~labels ~values), hoverinfo = 'text',
